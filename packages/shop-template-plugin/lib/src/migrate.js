...
async function ensureVersionTable(ds) {
    ...
    try {
        ...
        core_1.Logger.info('shop_template_version 表就绪', loggerCtx);
    }
    catch (e) {
        core_1.Logger.warn(`shop_template_version 建表失败(忽略): ${e.message}`, loggerCtx);
    }
}
