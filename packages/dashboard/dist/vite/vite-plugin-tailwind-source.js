 ...
 */
function resolveVendureUiSourcePath() {
    try {
        ...
        console.warn('[@vendure/dashboard] Could not resolve @vendure-io/ui source path. ' +
            'Tailwind CSS classes from @vendure-io/ui may be missing.', error);
        return undefined;
    }
}
/**
