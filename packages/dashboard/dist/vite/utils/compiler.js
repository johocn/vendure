...
export async function compile(options) {
    ...
    await compileTypeScript({
        ...
        sourceRoot: pathAdapter === null || pathAdapter === void 0 ? void 0 : pathAdapter.sourceRoot,
    });
 ...
 */
async function compileTypeScript({ inputPath, outputPath, logger, module, sourceRoot: customSourceRoot, }) {
    var _a;
    ...
    logger.debug(`tsConfig paths: ${JSON.stringify(originalTsConfigInfo === null || originalTsConfigInfo === void 0 ? void 0 : originalTsConfigInfo.paths, null, 2)}`);
    ...
    const sourceRoot = customSourceRoot !== null && customSourceRoot !== void 0 ? customSourceRoot : path.dirname(inputPath);
    ...
    const transformers = pathTransformer
 ...
 */
async function collectLocalSourceFiles(entryFile, tsConfigInfo) {
    ...
    async function processFile(filePath) {
        ...
        if (resolved.endsWith('.d.ts') || resolved.endsWith('.d.tsx'))
            return;
