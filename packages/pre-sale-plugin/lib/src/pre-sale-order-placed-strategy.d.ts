 ...
 */
export declare class PreSaleOrderPlacedStrategy extends DefaultOrderPlacedStrategy implements OrderPlacedStrategy {
    shouldSetAsPlaced(ctx: RequestContext, fromState: Order['state'], toState: Order['state'], order: Order): boolean;
}
