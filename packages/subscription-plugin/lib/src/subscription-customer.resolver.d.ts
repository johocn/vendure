...
export declare class SubscriptionCustomerResolver {
    ...
    availablePlans(ctx: RequestContext, shopId: ID, options: SubscriptionListOptions): Promise<{
        items: SubscriptionPlan[];
        totalItems: number;
    }>;
    mySubscriptions(ctx: RequestContext, options: SubscriptionListOptions): Promise<{
        items: Subscription[];
        totalItems: number;
    }>;
    mySubscriptionOccurrences(ctx: RequestContext, subscriptionId: ID, options: SubscriptionListOptions): Promise<{
