import{y as c,r as n,u as b,Z as m,j as L,di as p,g as d,a as f}from"./index-Db6dV6Bh.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const y=d(`
