import{aY as c,ay as n,az as b,b7 as m,j as L,e1 as p,L as d,aA as f}from"./index-B5sUqbxQ.js";function v(e){const{formatLanguageName:l}=c();return n.useMemo(()=>(e??[]).map(a=>({code:a,label:l(a)})).sort((a,s)=>a.label.localeCompare(s.label)),[e,l])}const y=d(`
