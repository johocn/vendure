 ...
 */
export const catalogCustomFields: CustomFields = {
    Product: [
        {
            name: 'belongCity',
            type: 'string',
    ...
    StockLocation: [
        {
            ...
            type: 'float',
            nullable: true,
            label: [{ languageCode: LanguageCode.zh_Hans, value: '门店/仓库纬度' }],
        },
        {
            name: 'lng',
            type: 'float',
            nullable: true,
            label: [{ languageCode: LanguageCode.zh_Hans, value: '门店/仓库经度' }],
        },
        {
            name: 'serviceCities',
            type: 'string',
    ...
    Order: [
        ...
        },
        {
            ...
            ui: {
                ...
                options: [
                    { value: 'delivery', label: [{ languageCode: LanguageCode.zh_Hans, value: '就近配送' }] },
                    { value: 'pickup', label: [{ languageCode: LanguageCode.zh_Hans, value: '到店自提' }] },
                ],
            },
        },
        {
