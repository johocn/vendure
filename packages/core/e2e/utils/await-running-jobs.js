...
exports.awaitRunningJobs = awaitRunningJobs;
const shared_definitions_1 = require("../graphql/shared-definitions");
/**
 ...
 */
async function awaitRunningJobs(adminClient, timeout = 5000, delay = 100) {
    let runningJobs = 0;
    ...
    do {
        const { jobs } = await adminClient.query(shared_definitions_1.getRunningJobsDocument, {
            options: {
                filter: {
                    isSettled: {
                        eq: false,
...
//# sourceMappingURL=await-running-jobs.js.map