...
exports.tieredQuantityShippingCalculator = exports.tieredWeightShippingCalculator = void 0;
 ...
 * - 超重附加费（单件超过阈值时加收）
 */
exports.tieredWeightShippingCalculator = new core_1.ShippingCalculator({
    code: 'tiered-weight-shipping-calculator',
    description: [
        { languageCode: core_1.LanguageCode.zh_Hans, value: '阶梯重量+区域计费' },
        { languageCode: core_1.LanguageCode.en, value: 'Tiered Weight + Region Shipping Calculator' },
    ],
    args: {
        // === 基础计费参数 ===
        firstWeight: {
            type: 'float',
            defaultValue: 1,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '首重(kg)' }],
        },
        firstWeightFee: {
            type: 'int',
            defaultValue: 1000,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '首重费用(分)' }],
        },
        additionalWeightUnit: {
            type: 'float',
            defaultValue: 1,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '续重单位(kg)' }],
        },
        additionalWeightFee: {
            type: 'int',
            defaultValue: 500,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '续重费用(分)' }],
        },
        // === 区域附加费 ===
        remoteAreaSurcharge: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '偏远地区附加费(分)' }],
        },
        remoteAreas: {
            type: 'string',
            defaultValue: '新疆,西藏,青海,内蒙古,宁夏,甘肃',
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '偏远地区(省份逗号分隔)' }],
        },
        // === 包邮策略 ===
        freeShippingThreshold: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '满额包邮门槛(分, 0=不启用)' }],
        },
        freeShippingAreas: {
            type: 'string',
            defaultValue: '',
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '指定省份免邮(逗号分隔, 留空=不启用)' }],
        },
        // === 体积重 ===
        useVolumetricWeight: {
            type: 'boolean',
            defaultValue: false,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '启用体积重计算' }],
        },
        volumetricDivisor: {
            type: 'int',
            defaultValue: 6000,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '体积重除数' }],
        },
        // === 运费封顶 ===
        maxShippingFee: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '运费封顶(分, 0=不限制)' }],
        },
        // === 保价费 ===
        insuranceFeeRate: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '保价费率(千分比, 0=不收取)' }],
        },
        insuranceMinFee: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '保价最低费用(分)' }],
        },
        // === 超重附加费 ===
        oversizedThreshold: {
            type: 'float',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '超重阈值(kg, 0=不检查)' }],
        },
        oversizedSurcharge: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '超重附加费(分)' }],
        },
    },
    calculate: (ctx, order, args) => {
        ...
        for (const line of order.lines) {
            ...
            const actualWeight = Number((_a = variant === null || variant === void 0 ? void 0 : variant.customFields) === null || _a === void 0 ? void 0 : _a.weight) || 0;
            ...
            if (args.useVolumetricWeight) {
                const l = Number((_b = variant === null || variant === void 0 ? void 0 : variant.customFields) === null || _b === void 0 ? void 0 : _b.length) || 0;
                const w = Number((_c = variant === null || variant === void 0 ? void 0 : variant.customFields) === null || _c === void 0 ? void 0 : _c.width) || 0;
                const h = Number((_d = variant === null || variant === void 0 ? void 0 : variant.customFields) === null || _d === void 0 ? void 0 : _d.height) || 0;
                if (l > 0 && w > 0 && h > 0) {
 ...
 */
exports.tieredQuantityShippingCalculator = new core_1.ShippingCalculator({
    code: 'tiered-quantity-shipping-calculator',
    description: [
        { languageCode: core_1.LanguageCode.zh_Hans, value: '阶梯件数计费' },
        { languageCode: core_1.LanguageCode.en, value: 'Tiered Quantity Shipping Calculator' },
    ],
    args: {
        firstItemFee: {
            type: 'int',
            defaultValue: 800,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '首件费用(分)' }],
        },
        additionalItemFee: {
            type: 'int',
            defaultValue: 200,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '续件费用(分)' }],
        },
        freeShippingThreshold: {
            type: 'int',
            defaultValue: 0,
        ...
        freeShippingQuantity: {
            type: 'int',
            defaultValue: 0,
            label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '满件包邮(件, 0=不启用)' }],
        },
        freeShippingAreas: {
            type: 'string',
            defaultValue: '',
...
// ===== 工具函数 =====
function getProvince(order) {
    const shippingAddress = order.shippingAddress;
    if (!shippingAddress)
        return '';
    return shippingAddress.province || '';
}
function getRemoteAreaSurcharge(order, args) {
    const province = getProvince(order);
    if (!province || !args.remoteAreas)
        return 0;
...
function applyMaxFee(fee, maxFee) {
    if (maxFee > 0 && fee > maxFee)
        return maxFee;
    return fee;
}
function calculateInsuranceFee(order, args) {
    if (!args.insuranceFeeRate || args.insuranceFeeRate <= 0)
        return 0;
...
//# sourceMappingURL=tiered-shipping-calculator.js.map