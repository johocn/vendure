...
exports.tenantChannelCustomFields = {
    Channel: [
        ...
        },
        {
            ...
            public: true,
            options: [
                { value: 'inclusive', label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '含税价' }, { languageCode: core_1.LanguageCode.en, value: 'Tax-inclusive' }] },
                { value: 'zero', label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '零税价' }, { languageCode: core_1.LanguageCode.en, value: 'Zero-tax' }] },
                { value: 'exclusive', label: [{ languageCode: core_1.LanguageCode.zh_Hans, value: '不含税价' }, { languageCode: core_1.LanguageCode.en, value: 'Tax-exclusive' }] },
            ],
            label: [
                { languageCode: core_1.LanguageCode.zh_Hans, value: '税率方式' },
                { languageCode: core_1.LanguageCode.en, value: 'Tax mode' },
            ],
            description: [
                { languageCode: core_1.LanguageCode.zh_Hans, value: 'inclusive=含税价(录入价即价内含税，结算拆税不额外加收)；zero=零税价(录入价即免税最终价)；exclusive=不含税价(录入价为净价，展示/结算按税率×1.13价税分离)。' },
                { languageCode: core_1.LanguageCode.en, value: 'inclusive=tax-inclusive display & settlement; zero=tax-free; exclusive=net price with 1.13 tax separation.' },
            ],
        },
        {
            ...
            defaultValue: false,
            label: [
                { languageCode: core_1.LanguageCode.zh_Hans, value: '开启物理库存' },
