...
export const tenantChannelCustomFields: CustomFields = {
    Channel: [
        ...
        },
        {
            ...
            type: 'string',
            nullable: true,
            label: [{ languageCode: LanguageCode.zh_Hans, value: '默认外网访问域名' }],
            description: [
                { languageCode: LanguageCode.zh_Hans, value: '租户默认对外访问域名（不含协议头），前端据此回源' },
            ],
        },
        {
            name: 'mapConfig',
            ...
            options: [
                {
                    value: 'off',
                    label: [
                        { languageCode: LanguageCode.zh_Hans, value: '关闭（不使用库位）' },
                        { languageCode: LanguageCode.en, value: 'Off' },
                    ],
                },
                {
                    value: 'zone',
                    label: [
                        { languageCode: LanguageCode.zh_Hans, value: '只用库区' },
                        { languageCode: LanguageCode.en, value: 'Zone only' },
                    ],
                },
                {
                    value: 'bin',
                    label: [
                        { languageCode: LanguageCode.zh_Hans, value: '完整库位（库区+库位）' },
                        { languageCode: LanguageCode.en, value: 'Full bins' },
                    ],
                },
            ],
        },
