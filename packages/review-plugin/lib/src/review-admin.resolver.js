...
exports.ReviewAdminResolver = void 0;
const graphql_1 = require("@nestjs/graphql");
const core_1 = require("@vendure/core");
const review_entity_1 = require("./review.entity");
const review_service_1 = require("./review.service");
let ReviewAdminResolver = class ReviewAdminResolver {
    constructor(reviewService) {
        this.reviewService = reviewService;
    }
    async reviews(ctx, options) {
...
exports.ReviewAdminResolver = ReviewAdminResolver;
__decorate([
    (0, graphql_1.Query)(),
...
], ReviewAdminResolver.prototype, "reviews", null);
__decorate([
    (0, graphql_1.Query)(),
    (0, core_1.Allow)(core_1.Permission.ReadOrder),
    __param(0, (0, core_1.Ctx)()),
    ...
    __metadata("design:paramtypes", [core_1.RequestContext, Object]),
    __metadata("design:returntype", Promise)
], ReviewAdminResolver.prototype, "review", null);
__decorate([
    (0, graphql_1.Query)(),
    (0, core_1.Allow)(core_1.Permission.ReadOrder),
    __param(0, (0, core_1.Ctx)()),
...
__decorate([
    ...
    __param(0, (0, core_1.Ctx)()),
    __param(1, (0, graphql_1.Args)('id')),
    __param(2, (0, graphql_1.Args)('reply')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [core_1.RequestContext, Object, String]),
    __metadata("design:returntype", Promise)
], ReviewAdminResolver.prototype, "replyReview", null);
__decorate([
    (0, graphql_1.Mutation)(),
    (0, core_1.Allow)(core_1.Permission.UpdateOrder),
    __param(0, (0, core_1.Ctx)()),
    ...
    __metadata("design:paramtypes", [core_1.RequestContext, Object]),
    __metadata("design:returntype", Promise)
], ReviewAdminResolver.prototype, "approveReview", null);
__decorate([
    (0, graphql_1.Mutation)(),
    (0, core_1.Allow)(core_1.Permission.UpdateOrder),
    __param(0, (0, core_1.Ctx)()),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReviewAdminResolver.prototype, "customerName", null);
exports.ReviewAdminResolver = ReviewAdminResolver = __decorate([
    (0, graphql_1.Resolver)('Review'),
    __metadata("design:paramtypes", [review_service_1.ReviewService])
], ReviewAdminResolver);
//# sourceMappingURL=review-admin.resolver.js.map